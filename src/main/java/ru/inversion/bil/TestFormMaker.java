        ...
        if (engine != null) {
            try {
                ...
                String testScript = "// Тестирование FormMaker методов\n" +
                        "print(\"Testing FormMaker methods:\");\n" +
                        "print(\"\");\n" +
                        "\n" +
                        "// Метод print\n" +
                        "_FM.print(\"This is \");\n" +
                        ...
                        "\n" +
                        "// Метод println\n" +
                        "_FM.print(\"This is FormMaker println method!\");\n" +
                        "print(\"\");\n" +
                        "\n" +
                        "// Метод line\n" +
                        "_FM.line();\n" +
                        "print(\"Above is a line from FormMaker\");\n" +
                        "_FM.line();\n" +
                        "print(\"\");\n" +
                        "\n" +
                        ...
                        "_FM.print(\"Starting \");\n" +
                        "_FM.print(\"report generation...\");\n" +
                        "_FM.line();\n" +
                        "_FM.report(\"Report item 1\", \"Report item 2\", \"Report item 3\");\n" +
                        "_FM.line();\n" +
                        "_FM.print(\"Report generation completed!\");\n" +
                        "\n" +
